...
export const getProducts = createAsyncThunk("searchSlice/getProducts", async(query: string, thunkAPI) => {
    try {
        const API_URL = `/api/products/search/${query}`
...
export const { reset, sortProducts, filterProducts, resetFilters } = searchSlice.actions
