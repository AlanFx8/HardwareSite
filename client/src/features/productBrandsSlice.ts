...
export const getProducts = createAsyncThunk("productBrandsSlice/getProducts", async(id: string, thunkAPI) => {
    try {
        const API_URL = `/api/products/brands/${id}`
...
export const { reset, sortProducts, filterProducts, resetFilters } = productBrandsSlice.actions
